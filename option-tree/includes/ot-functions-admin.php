          ...
          array(
            ...
            'pages'               => array(
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( '&Eacute;coute Prolong&eacute;e', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( '&Eacute;coute Prolong&eacute;e', 'option-tree' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Options mises &agrave; jour.', 'option-tree' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Options remises &agrave; z&eacute;ro', 'option-tree' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'Sauvegarde p&eacute;d&eacute; !', 'option-tree' ) ),
                'screen_icon'     => 'themes',
