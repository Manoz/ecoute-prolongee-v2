...
! function(a) {
    a.fullwidthAudioPlayer = {
        ...
        function c(b) {
            if (J.storePlaylist && "undefined" == typeof amplify) return alert("Please include the amplify.min.js file in your document!"), !1;
            if (A = a(b), A.hide(), U = "fap-popup" == b.id, z()) {
                if (J.hideOnMobile) return !1;
                J.autoPlay = J.volume = J.playlist = !1, J.wrapperPosition = "top"
            }
            if (I = Boolean(window.fapPopupWin), J.autoPopup || (I = !0), H = !J.autoPlay, h(), L = J.playlist ? J.height + J.playlistHeight + J.offset : J.height, "popup" == J.wrapperPosition && !U) return J.layout = "fullwidth", T = !0, J.playlist || (L = J.height), J.autoPopup && !window.fapPopupWin && d(A.html(), J.autoPlay), !1;
            SC.initialize({
                client_id: "67d4fcc41ea89a69f5597f3f96d0d9ce"
            });
            var c = '<div id="fap-wrapper" class="' + ("top" == J.wrapperPosition ? "fap-wrapper-top" : "fap-wrapper-bottom") + '" style="' + J.wrapperPosition + ": 0; height: " + L + 'px;"><div id="fap-main" style="color:' + J.mainColor + ';"><div id="fap-wrapper-switcher" style="background: ' + J.wrapperColor + "; border-color: " + J.strokeColor + '"></div><p id="fap-init-text">Creating Playlist...</p></div></div>';
            a("body").append(c), B = a("body").children("#fap-wrapper"), C = B.children("#fap-main"), "fullwidth" == J.layout ? B.addClass("fap-fullwidth").css({
                background: J.wrapperColor,
                borderColor: J.strokeColor
            }) : "boxed" == J.layout && (B.addClass("fap-boxed"), C.css({
                background: J.wrapperColor,
                borderColor: J.strokeColor
            })), U && B.addClass("fap-popup-skin"), z() && B.css({
                position: "absolute"
            }), U ? C.css({
                marginLeft: 10,
                marginRight: 10
            }) : "center" == J.mainPosition ? C.css({
                marginLeft: "auto",
                marginRight: "auto"
            }) : "right" == J.mainPosition ? C.css({
                "float": "right",
                marginRight: 10
            }) : C.css({
                marginLeft: 10
            }), "top" == J.wrapperPosition ? C.children("#fap-wrapper-switcher").addClass("fap-bordered-bottom").css({
                bottom: -15,
                borderTop: "none"
            }) : C.children("#fap-wrapper-switcher").addClass("fap-bordered-top").css({
                top: -15,
                borderBottom: "none"
            }), J.opened ? a.fullwidthAudioPlayer.setPlayerPosition("open", !1) : a.fullwidthAudioPlayer.setPlayerPosition("close", !1), C.children("#fap-wrapper-switcher").click(function() {
                J.opened ? a.fullwidthAudioPlayer.setPlayerPosition("close", !0) : a.fullwidthAudioPlayer.setPlayerPosition("open", !0)
        ...
        function d(b, c) {
            if (!window.fapPopupWin || window.fapPopupWin.closed) {
                var d = 980,
                    ...
                    f = (window.screen.height - L) / 2,
                    g = /Chrome/i.test(navigator.userAgent);
                window.fapPopupWin = window.open(J.popupUrl, "", "menubar=no,toolbar=no,location=yes,status=no,width=" + d + ",height=" + (g ? L + 30 : L) + ",left=" + e + ",top=" + f), null == window.fapPopupWin && alert("Pop-Up Music Player can not be opened. Your browser is blocking Pop-Ups. Please allow Pop-Ups for this site to use the Music Player."), a(window.fapPopupWin).load(function() {
                    a(window.fapPopupWin).animate({
                        innerHeight: L
                    }, 500), a('.fap-single-track[data-autoenqueue="yes"]').each(function(c, d) {
                        var e = a(d);
                        b += i(e)
                    }), J.autoPlay = c, window.fapPopupWin.initPlayer(J, b), I = !0
                })
            } else {
                var h = a(b);
                a.fullwidthAudioPlayer.addTrack(h.attr("href"), h.attr("title"), h.data("meta") ? a("body").find(h.data("meta")).html() : "", h.attr("rel"), h.attr("target"), c)
            }
        }
        ...
        function e() {
            if (J.playlist) {
                ...
                K = a(b).css("height", J.playlistHeight)
            }
            J.xmlPath ? a.ajax({
                type: "GET",
                url: J.xmlPath,
                ...
                success: function(b) {
                    var c = a(b).find("playlists"),
                        d = d = J.xmlPlaylist ? J.xmlPlaylist : c.children("playlist:first").attr("id");
        ...
        function f(b) {
            if (J.storePlaylist) var c = Boolean(amplify.store("fap-playlist"));
            b = c ? JSON.parse(amplify.store("fap-playlist")) : b, A.bind("fap-tracks-stored", function() {
                if (++M, M < b.length)
                    if (J.storePlaylist && c) {
                        var d = b[M];
                        a.fullwidthAudioPlayer.addTrack(d.stream_url, d.title, d.meta, d.artwork_url, d.permalink_url, J.autoPlay)
                    } else {
                        var d = b.eq(M);
                        a.fullwidthAudioPlayer.addTrack(d.attr("href"), d.attr("title"), J.xmlPath ? d.children("meta").text() : A.find(d.data("meta")).html(), d.attr("rel"), d.attr("target"), J.autoPlay)
                    } else A.unbind("fap-tracks-stored"), J.randomize && u(), g()
            }).trigger("fap-tracks-stored")
        }

        function g() {
            C.children("p").remove(), C.append('<div id="fap-meta-wrapper" class="clearfix"><img src="" id="fap-current-cover" style="width: ' + J.coverSize[0] + "px; height:" + J.coverSize[1] + "px; border: 1px solid " + J.strokeColor + ';" /><div id="fap-cover-replacement" style="width: ' + J.coverSize[0] + "px; height:" + J.coverSize[1] + "px; border: 1px solid " + J.strokeColor + ';"></div><p id="fap-current-title" style="color: ' + J.mainColor + ';"></p><p id="fap-current-meta" style="color: ' + J.metaColor + ';"></p></div>'), E = C.children("#fap-meta-wrapper").css("height", J.height - 10), q(document.getElementById("fap-cover-replacement"), J.coverSize[0], J.coverSize[1]), J.socials && E.append('<p id="fap-social-links"><a href="" target="_blank" style="color: ' + J.metaColor + ';">' + J.facebookText + '</a><a href="" target="_blank" style="color: ' + J.metaColor + ';">' + J.twitterText + '</a><a href="" target="_blank" style="color: ' + J.metaColor + ';">' + J.downloadText + '</a><a href="" target="_blank" class="fap-soundcloud-link"></a></p>'), D = C.append('<div id="fap-ui-wrapper"></div>').children("#fap-ui-wrapper").css("height", J.height);
            var b = D.append('<div id="fap-ui-nav"></div>').children("#fap-ui-nav");
            if (b.css("margin-top", .5 * J.height - .5 * b.height()), b.append('<a href="#" id="fap-previous" style="background-color: ' + J.fillColor + ';"></a>').children("#fap-previous").click(function() {
                return a.fullwidthAudioPlayer.previous(), !1
            }), b.append('<a href="#" id="fap-play-pause" style="background-color: ' + J.fillColor + ';"></a>').children("#fap-play-pause").click(function() {
                return a.fullwidthAudioPlayer.toggle(), !1
            }), b.append('<a href="#" id="fap-next" style="background-color: ' + J.fillColor + ';"></a>').children("#fap-next").click(function() {
                return a.fullwidthAudioPlayer.next(), !1
            }), D.children("div:first").length ? D.width() - D.children("div:first").position().left + 20 : 0, D.append('<div id="fap-time-bar" class="clearfix" style="width: ' + N + "px; border: 1px solid " + J.fillColor + "; margin-top: " + (.5 * J.height - 3) + "px; color: " + J.metaColor + ';"><div id="fap-loading-bar" style="background: ' + J.fillColor + ';"></div><div id="fap-progress-bar" style="background: ' + J.mainColor + ';"></div><span id="fap-current-time">00:00:00</span><span id="fap-total-time">00:00:00</span></div>'), D.find("#fap-loading-bar, #fap-progress-bar").click(function(b) {
                var c = (b.pageX - a(this).parent().offset().left) / N;
                F.setPosition(c * F.duration), r(c)
            }), J.volume) {
                var c = J.playlist || J.shuffle ? 60 : 20;
                U && (c = J.shuffle ? 60 : 20), D.append('<div id="fap-volume-bar" style="width: ' + O + "px; background: " + J.fillColor + "; border: 1px solid " + J.fillColor + "; margin-top: " + (.5 * J.height - 3) + 'px;"><div id="fap-volume-progress" style="background: ' + J.mainColor + ';"></div></div><div id="fap-volume-sign"></div>'), D.children("#fap-volume-sign").css("margin-top", .5 * J.height - .5 * D.children("#fap-volume-sign").height()), D.find("#fap-volume-bar").click(function(b) {
                    var c = (b.pageX - a(this).offset().left) / O;
                    a.fullwidthAudioPlayer.volume(c)
                })
            }
            if (J.playlist) {
                if ("bottom" == J.wrapperPosition ? (C.append('<div class="clear"></div>').append(K), K.css({
                    marginTop: J.offset
                })) : (C.prepend('<div class="clear"></div>').prepend(K), K.css({
                    marginBottom: J.offset
                })), K.niceScroll({
                    cursorcolor: J.mainColor,
                    cursorborder: "none",
                    autohidemode: !1
                }), K.getNiceScroll().hide(), a(".nicescroll-rails").hover(function() {
                    K.getNiceScroll().resize().show()
                }, function() {
                    K.getNiceScroll().resize().hide()
                }), K.hover(function() {
                    K.getNiceScroll().resize().show()
                }, function() {
                    K.getNiceScroll().resize().hide()
                    ...
                    var d;
                    K.sortable().bind("sortstart", function(a, b) {
                        b.item.addClass("fap-prevent-click"), d = K.children("li").index(b.item)
                    }), K.sortable().bind("sortupdate", function(a, b) {
                        var c = K.children("li").index(b.item),
                            e = V[d],
                            f = V[P].title;
                        V.splice(d, 1), V.splice(c, 0, e), w(f), J.storePlaylist && amplify.store("fap-playlist", JSON.stringify(V))
                    })
                }
                U ? a.fullwidthAudioPlayer.setPlayerPosition("openPlaylist", !1) : (D.append('<a title="Ouvrir la playlist" href="#" id="fap-playlist-toggle" style="background-color:' + J.fillColor + "; margin-top: " + (.5 * J.height - 12) + 'px;"></a>'), D.children("#fap-playlist-toggle").click(function() {
                    return R ? a.fullwidthAudioPlayer.setPlayerPosition("closePlaylist", !0) : a.fullwidthAudioPlayer.setPlayerPosition("openPlaylist", !0), !1
                }))
                U ? a.fullwidthAudioPlayer.setPlayerPosition("clearPlaylist", !1) : (D.append('<a title="Vider la playlist" href="#" id="fap-clear-toggle" style="background-color:' + J.fillColor + "; margin-top: " + (.5 * J.height - 12) + 'px;"></a>')), D.children("#fap-clear-toggle").click(function() {
                    return a.fullwidthAudioPlayer.clear(), !1
                })
            }
            J.shuffle && (D.append('<a href="#" id="fap-playlist-shuffle" style="background-color:' + J.fillColor + "; margin-top: " + (.5 * J.height - 12) + 'px;"></a>'), D.children("#fap-playlist-shuffle").click(function() {
                return u(), !1
            })), D.find("a").hover(function() {
                a(this).css("backgroundColor", J.fillColorHover)
            }, function() {
                a(this).css("backgroundColor", J.fillColor)
            }), J.keyboard && a(document).keyup(function(b) {
                switch (b.which) {
                    case 32:
            ...
            }), E.children("p").css("marginLeft", J.coverSize[0] + 10), A.trigger("onFapReady"), I = !0, a('.fap-single-track[data-autoenqueue="yes"]').each(function(b, c) {
                var d = a(c);
                jQuery.fullwidthAudioPlayer.addTrack(d.attr("href"), d.attr("title"), a("body").find(d.data("meta")).html(), d.attr("rel"), d.attr("target"), !1)
            }), A.bind("fap-tracks-stored", function(b, c) {
                S && a.fullwidthAudioPlayer.selectTrack(c, S)
            }), a.fullwidthAudioPlayer.selectTrack(0, /Android|webOS|iPhone|iPod|iPad|BlackBerry/i.test(navigator.userAgent) ? !1 : J.autoPlay), J.autoPlay ? A.trigger("onFapPlay") : A.trigger("onFapPause")
        }
        ...
        function h() {
            function b() {
                ...
                var b = a(this),
                    c = !0;
                if (b.data("enqueue") && (c = "yes" == b.data("enqueue") ? !1 : !0), T)
                    if (b.hasClass("fap-add-playlist")) {
                        var e = b.data("playlist"),
                            f = jQuery('ul[data-playlist="' + e + '"]').first().children("li").find(".fap-single-track"),
                            g = i(a(f.get(0)));
                        if (0 == f.size()) return !1;
                        d(g, c), f.splice(0, 1), window.fapReady = void 0 != window.fapPopupWin.addTrack;
                        var h = setInterval(function() {
                            window.fapReady && (clearInterval(h), f.each(function(a, b) {
                                d(b, c)
                            }))
                        }, 50)
                    } else {
                ...
                if (b.hasClass("fap-add-playlist")) {
                    var e = b.data("playlist"),
                        f = jQuery('ul[data-playlist="' + e + '"]').first().children("li").find(".fap-single-track");
                    if (0 == f.size()) return !1;
                    M = -1, A.bind("fap-tracks-stored", function() {
                        if (++M, M < f.size()) {
                            var b = f.eq(M);
                            a.fullwidthAudioPlayer.addTrack(b.attr("href"), b.attr("title"), a("body").find(b.data("meta")).html(), b.attr("rel"), b.attr("target"), 0 == M && c)
                        } else A.unbind("fap-tracks-stored")
                    }).trigger("fap-tracks-stored")
                } else a.fullwidthAudioPlayer.addTrack(b.attr("href"), b.attr("title"), a("body").find(b.data("meta")).html(), b.attr("rel"), b.attr("target"), c);
                return !1
            }
            A.jquery >= "1.7" ? (a("body").on("click", ".fap-my-playlist li a.fap-single-track, .fap-single-track", b), a("body").on("click", ".fap-add-playlist", b)) : (a("body").delegate(".fap-my-playlist li a.fap-single-track, .fap-single-track", "click", b), a("body").delegate(".fap-add-playlist", "click", b))
        }
        ...
        function j(b) {
            if (RegExp("http(s?)://soundcloud").test(b)) b = b.replace("/likes", "/favorites"), SC.get("/resolve", {
                url: b
            }, function(b, c) {
                if (c && c.message) return !1;
                var d = -1,
                    e = -1;
                if (a.isArray(b))
                    ...
                    A.trigger("onFapTracksAdded", [V]), A.trigger("fap-tracks-stored", [d])
                }) : "group" == b.kind ? SC.get("/groups/" + b.id + "/tracks", function(a) {
                    for (var b = 0; b < a.length; ++b) e = k(a[b]), d = d > e ? e : d, 0 == b && (d = e);
                    A.trigger("onFapTracksAdded", [V]), A.trigger("fap-tracks-stored", [d])
                }) : "track" == b.kind && (d = k(b));
                d >= 0 && (A.trigger("onFapTracksAdded", [V]), A.trigger("fap-tracks-stored", [d]))
            });
                ...
                a.getJSON("http://api.official.fm/tracks/" + c + "?fields=streaming,cover&api_version=2", function(a) {
                    ...
                    A.trigger("onFapTracksAdded", [V]), A.trigger("fap-tracks-stored", [c])
                })
            }
        }
        ...
        function k(a) {
            for (var b = V.length, c = 0; c < V.length; ++c)
                if (a.title == V[c].title) return b = c;
            return V.push(a), p(a.artwork_url, a.title), J.storePlaylist && amplify.store("fap-playlist", JSON.stringify(V)), b
        }

        function l() {
            D.find("#fap-loading-bar").width(this.bytesLoaded / this.bytesTotal * N)
        }
        ...
        function n() {
            J.playNextWhenFinished ? a.fullwidthAudioPlayer.next() : (a.fullwidthAudioPlayer.pause(), F.setPosition(0), r(0))
        }
        ...
        function p(b, c) {
            ...
            function e() {
                ...
                V.splice(c, 1), b.parent().remove(), c == P ? (P--, c = c == V.length ? 0 : c, a.fullwidthAudioPlayer.selectTrack(c, H ? !1 : !0)) : P > c && P--, K.getNiceScroll().resize(), J.storePlaylist && amplify.store("fap-playlist", JSON.stringify(V))
            }
            if (!J.playlist) return !1;
            var f = b ? '<img src="' + b + '" style="border: 1px solid ' + J.strokeColor + ';" />' : '<div class="fap-cover-replace-small" style="background: ' + J.wrapperColor + "; border: 1px solid " + J.strokeColor + ';"></div>';
            K.append('<li class="clearfix">' + f + "<span>" + c + '</span><div class="fap-remove-track">&times;</div></li>');
            var g = K.children("li").last().css({
                marginBottom: 5,
                height: 22
            }); - 1 == navigator.appVersion.indexOf("MSIE 7.") && (b || q(g.children(".fap-cover-replace-small").get(0), 20, 20)), A.jquery >= "1.7" ? (g.on("click", "span", d), g.on("click", ".fap-remove-track", e)) : (g.delegate("span", "click", d), g.delegate(".fap-remove-track", "click", e)), K.getNiceScroll().resize()
        }

        function q(b, c, d) {
            a(b).append('<span style="line-height: ' + d + "px; color: " + J.metaColor + ';">&hellip;</span>')
        }

        function r(a) {
            D.find("#fap-progress-bar").width(a * N)
        }

        function s(a, b) {
            var c = t(a / 1e3);
            G != c && (D.find("#fap-current-time").text(c), D.find("#fap-total-time").text(t(b / 1e3)), r(a / b)), G = c
        }
        ...
        function u() {
            if (K && K.empty(), -1 != P) {
                ...
                C.find("#fap-playlist").children("li").eq(P).css("backgroundColor", J.fillColor), C.find("#fap-playlist").scrollTop(0)
            } else {
                V.shuffle();
                for (var b = 0; b < V.length; ++b) p(V[b].artwork_url, V[b].title)
            }
            J.storePlaylist && amplify.store("fap-playlist", JSON.stringify(V))
        }
        ...
        function x(a) {
            var b, c, d, e, f, g, h, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
                j = "",
                k = 0;
            for (a = a.replace(/[^A-Za-z0-9\+\/\=]/g, ""); k < a.length;) e = i.indexOf(a.charAt(k++)), f = i.indexOf(a.charAt(k++)), g = i.indexOf(a.charAt(k++)), h = i.indexOf(a.charAt(k++)), b = e << 2 | f >> 4, c = (15 & f) << 4 | g >> 2, d = (3 & g) << 6 | h, j += String.fromCharCode(b), 64 != g && (j += String.fromCharCode(c)), 64 != h && (j += String.fromCharCode(d));
            return j = y(j)
        }
        ...
        var A, B, C, SS, D, E, F, G, H, I, J = a.extend({}, a.fn.fullwidthAudioPlayer.defaults, b),
            K = null,
            L = 0,
            M = -1,
            N = 180,
        ...
        return a.fullwidthAudioPlayer.play = function() {
            -1 == P && a.fullwidthAudioPlayer.next(), V.length > 0 && (F.playState ? F.resume() : F.play(), D.find("#fap-play-pause").removeClass("fap-play").addClass("fap-pause"), H = !1, A.trigger("onFapPlay"))
        }, a.fullwidthAudioPlayer.pause = function() {
            V.length > 0 && (F.pause(), D.find("#fap-play-pause").removeClass("fap-pause").addClass("fap-play"), H = !0, A.trigger("onFapPause"))
        }, a.fullwidthAudioPlayer.toggle = function() {
            H ? a.fullwidthAudioPlayer.play() : a.fullwidthAudioPlayer.pause()
            ...
            V.length > 0 && (0 > a && (a = 0), a > 1 && (a = 1), Q = 100 * a, F && F.setVolume(Q), D.find("#fap-volume-progress").width(a * O))
        }, a.fullwidthAudioPlayer.addTrack = function(b, c, d, e, f, g) {
            if (null == b || "" == b) return alert('The track with the title "' + c + '" does not contain a track URI to a MP3 file or to a soundcloud resource!'), !1;
            if (void 0 === c && (c = ""), void 0 === d && (d = ""), void 0 === e && (e = ""), void 0 === f && (f = ""), void 0 === g && (g = !1), T && window.fapPopupWin && !window.fapPopupWin.closed) return window.fapPopupWin.addTrack(b, c, d, e, f, g), window.fapPopupWin.focus(), !1;
            if (J.base64 && (b = x(b)), S = g, RegExp("http(s?)://soundcloud").test(b) || RegExp("http(s?)://official.fm").test(b)) j(b);
            else {
                var h = k({
                    stream_url: b,
                    title: c,
                ...
                A.trigger("onFapTracksAdded", [V]), A.trigger("fap-tracks-stored", [h])
            }
            J.opened || !g || U || a.fullwidthAudioPlayer.setPlayerPosition("open", !0)
            ...
            } else E.children("#fap-social-links").children("a").hide();
            K && (K.children("li").css("background", "none"), K.children("li").eq(P).css("background", J.activeTrackColor), K.scrollTop(K.children("li").eq(0).outerHeight(!0) * P)), c ? D.find("#fap-play-pause").removeClass("fap-play").addClass("fap-pause") : D.find("#fap-play-pause").removeClass("fap-pause").addClass("fap-play"), F && F.destruct();
            var g = {
                id: "fap_sound",
                autoPlay: c,
                autoLoad: J.autoLoad,
            ...
            d ? (E.children("#fap-social-links").children("a:eq(3)").show(), V[P].downloadable ? E.children("#fap-social-links").children("a:eq(2)").show() : E.children("#fap-social-links").children("a:eq(2)").hide(), a.extend(g, {
                id: "fap_sound",
                url: V[P].stream_url + "?client_id=" + SC.options.client_id
            })) : (E.children("#fap-social-links").children("a:eq(2), a:eq(3)").hide(), a.extend(g, {
                id: "fap_sound",
                url: V[P].stream_url
            })), F = soundManager.createSound(g), A.trigger("onFapTrackSelect", [V[P]])
        }, a.fullwidthAudioPlayer.setPlayerPosition = function(a, b) {
            return B.is(":animated") ? !1 : ("open" == a ? (C.children("#fap-wrapper-switcher").html("&times;"), "top" == J.wrapperPosition ? B.animate({
                top: -(L - J.height)
            }, b ? 300 : 0) : B.animate({
                bottom: -(L - J.height)
            }, b ? 300 : 0), J.opened = !0) : "close" == a ? (C.children("#fap-wrapper-switcher").html("+"), "top" == J.wrapperPosition ? B.animate({
                top: -L - 1
            }, b ? 300 : 0) : B.animate({
                bottom: -L - 1
            }, b ? 300 : 0), J.opened = R = !1) : "openPlaylist" == a ? ("top" == J.wrapperPosition ? B.animate({
                top: 0
            }, 300, function() {
                K.getNiceScroll().resize().show()
            }) : B.animate({
                ...
                K.getNiceScroll().resize().show()
            }), R = !0) : "closePlaylist" == a && (K.getNiceScroll().hide(), "top" == J.wrapperPosition ? B.animate({
                top: -(L - J.height)
            }, 300) : B.animate({
                bottom: -(L - J.height)
            }, 300), R = !1), void 0)
        }, a.fullwidthAudioPlayer.clear = function() {
            E.children("#fap-current-cover").hide(), E.children("#fap-cover-replacement").show(), E.children("#fap-current-title, #fap-current-meta").html(""), E.children("#fap-social-links").children("a").attr("href", "").hide(), D.find("#fap-progress-bar, #fap-loading-bar").width(0), D.find("#fap-current-time, #fap-total-time").text("00:00:00"), D.find("#fap-play-pause").removeClass("fap-pause").addClass("fap-play"), H = !0, P = -1, K && K.empty(), V = [], F && F.destruct(), J.playlist && K.getNiceScroll().resize(), A.trigger("onFapClear")
        }, a.fullwidthAudioPlayer.popUp = function() {
            T && (!window.fapPopupWin || window.fapPopupWin.closed ? d("", !1) : window.fapPopupWin.focus())
    ...
    var l = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        o = function(a, i) {
            ...
            if (this.hasmousefocus = this.hasfocus = this.zoomactive = this.zoom = this.selectiondrag = this.cursorfreezed = this.cursor = this.rail = !1, this.visibility = !0, this.hidden = this.locked = !1, this.cursoractive = !0, this.overflowx = t.opt.overflowx, this.overflowy = t.opt.overflowy, this.nativescrollingarea = !1, this.checkarea = 0, this.events = [], this.saved = {}, this.delaylist = {}, this.synclist = {}, this.lastdeltay = this.lastdeltax = 0, n) u = n;
                ...
                v.cursorgrabvalue = w,
                v.hasmousecapture = "setCapture" in u,
                v.hasMutationObserver = !1 !== l,
                u = null,
                u = n = v
            }
            this.detected = u;
